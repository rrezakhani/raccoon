...
#include "ADCoefMatSourceTime.h"
#include "Executioner.h"

registerADMooseObject("raccoonApp", ADCoefMatSourceTime);

InputParameters
ADCoefMatSourceTime::validParams()
{
...
ADCoefMatSourceTime::ADCoefMatSourceTime(const InputParameters & parameters)
...
ADReal
ADCoefMatSourceTime::precomputeQpResidual()
{
  ADReal factor = 1.0;
